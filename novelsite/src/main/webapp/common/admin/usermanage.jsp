											...
											<c:forEach var="item" items="${requestScope.readers}"
												...
												<tr class="active">
													...
													<td
														...
														${item.shortInfo}</td>
													<td><input class="btn btn-primary radius"
														type="button" value="禁用"></td>

													<td><input class="btn btn-danger radius" type="button"
														value="删除"> <!-- <a href="#">删除</a> <a href="#">删除</a> <a href="#">删除</a> -->
													</td>
												</tr>
