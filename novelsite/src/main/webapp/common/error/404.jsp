...
<body>
	<nav class="shelf">
	  <a href="/novelsite/indexview/index" target="_blank" class="book home">轩文阁首页</a>
	  <a href="http://wpa.qq.com/msgrd?v=3&uin=1264308633&site=qq&menu=yes" target="_blank" class="book dz">联系管理员</a>
	  <a href="/novelsite/indexview/index" target="_blank" class="book vip">想看书</a>
